                ...
                const forgetEmail = {
                    ...
                    <body style="background-color: #e9ecef;">
                      ...
                      <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
                         IEMIS teacher password reset request  👻!!!
                      </div>
                      <!-- end preheader -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                              <a href="${process.env.SITE_URI}/auth/teacher/reset/${result.resetToken}"  target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Reset Password</a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                              ...
                              <tr>
                                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                  ...
                                  <p style="margin: 0;"><a href="${process.env.SITE_URI}/auth/teacher/reset/${result.resetToken}" target="_blank"> ${process.env.SITE_URI}/auth/teacher/reset/${result.resetToken} </a></p>
                                </td>
                              </tr>
                              <!-- end copy -->
      ...
      teacher.save((er, result)=>{
          ...
          const resetEmail = {
            ...
            <body style="background-color: #e9ecef;">
              ...
              <!-- start preheader -->
              <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
                 IEMIS Teacher password successfully reset  👻!!!
              </div>
              <!-- end preheader -->
